"""
Tests that require real audio files and test application functionality
"""
import pytest
import numpy as np
import wave
...
class TestWithRealAudio:
    ...
    def test_real_audio_transcription_accuracy(self, audio_data):
        ...
        if result['word_count'] > 0:
            ...
            assert result['wpm'] < 1000  # Sanity check - shouldn't be impossibly fast
    ...
    def test_real_audio_pace_analysis(self, audio_data):
        ...
        if result['word_count'] > 0:
            ...
            assert pace_feedback['status'] in ['too_fast', 'too_slow', 'good', 'unknown']
...
class TestApplicationStartup:
    ...
    def test_main_components_initialize_with_real_conditions(self):
        ...
        try:
            ...
            assert hasattr(timeline, 'add_event')
